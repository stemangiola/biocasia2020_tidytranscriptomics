...
We proceed to plot. 
_Note: we don't need to create many of these temporary variables. Here are created for educational purposes only._
...
We have precalculated the cluster classification
